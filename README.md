...
----------------
 - you are reading readme for Cornz (ticker ZCz)
 - coin unit: Tonz of Cornz
 - underlying commodity: Corn price in USD (future contract year+1 March ending)
 - price on 2013 Nov. 12: USD 426 per ton
 - underlying commodity price: http://finance.yahoo.com/webservice/v1/symbols/ZCH15.CBT/quote?format=json
