...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "ZCz " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"a.bitcommoditiz.org", "zcz.bitcommoditiz.org"},
    {"b.bitcommoditiz.org", "zcz.bitcommoditiz.org"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"a.bitcommoditiz.org", "testnet.zcz.bitcommoditiz.org"},
    {"b.bitcommoditiz.org", "testnet.zcz.bitcommoditiz.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. ZCz is probably already running."), addrBind.ToString().c_str());
        else
